...
public class ChitietActivity extends AppCompatActivity {
    ...
    private void InitData(){
        sanPhamMoi = (SanPhamMoi) getIntent().getSerializableExtra("chitiet", SanPhamMoi.class);
        ...
        ArrayAdapter<Integer> adapterspin = new ArrayAdapter<>(this, androidx.constraintlayout.widget.R.layout.support_simple_spinner_dropdown_item, arr);
